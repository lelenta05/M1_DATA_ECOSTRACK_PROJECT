...
--FAIT
CREATE TABLE IF NOT EXISTS oltp.FAIT_MESURES(
	id_fm bigserial,
	...
	timestamp_mesure TIMESTAMP NOT NULL,--date : 2025-12-27 15:42:01  (1) +++*++++ +++++ 15:43:30
...
CREATE TABLE oltp.fill_history_202401 PARTITION OF oltp.FAIT_MESURES FOR VALUES FROM ('2024-01-01 00:00:00') TO ('2024-02-01 00:00:00');
CREATE TABLE oltp.fill_history_202402 PARTITION OF oltp.FAIT_MESURES FOR VALUES FROM ('2024-02-01 00:00:00') TO ('2024-03-01 00:00:00');
CREATE TABLE oltp.fill_history_202403 PARTITION OF oltp.FAIT_MESURES FOR VALUES FROM ('2024-03-01 00:00:00') TO ('2024-04-01 00:00:00');
CREATE TABLE oltp.fill_history_202404 PARTITION OF oltp.FAIT_MESURES FOR VALUES FROM ('2024-04-01 00:00:00') TO ('2024-05-01 00:00:00');
CREATE TABLE oltp.fill_history_202405 PARTITION OF oltp.FAIT_MESURES FOR VALUES FROM('2024-05-01  00:00:00') TO ('2024-06-01 00:00:00');
CREATE TABLE oltp.fill_history_202406 PARTITION OF oltp.FAIT_MESURES FOR VALUES FROM ('2024-06-01 00:00:00') TO ('2024-07-01 00:00:00');
CREATE TABLE oltp.fill_history_202407 PARTITION OF oltp.FAIT_MESURES FOR VALUES FROM ('2024-07-01 00:00:00') TO ('2024-08-01 00:00:00');
CREATE TABLE oltp.fill_history_202408 PARTITION OF oltp.FAIT_MESURES FOR VALUES FROM ('2024-08-01 00:00:00') TO ('2024-09-01 00:00:00');
CREATE TABLE oltp.fill_history_202409 PARTITION OF oltp.FAIT_MESURES FOR VALUES FROM ('2024-09-01 00:00:00') TO ('2024-10-01 00:00:00');
CREATE TABLE oltp.fill_history_202410 PARTITION OF oltp.FAIT_MESURES FOR VALUES FROM ('2024-10-01 00:00:00') TO ('2024-11-01 00:00:00');
CREATE TABLE oltp.fill_history_202411 PARTITION OF oltp.FAIT_MESURES FOR VALUES FROM ('2024-11-01 00:00:00') TO ('2024-12-01 00:00:00');
CREATE TABLE oltp.fill_history_202412 PARTITION OF oltp.FAIT_MESURES FOR VALUES FROM ('2024-12-01 00:00:00') TO ('2025-01-01 00:00:00');
...
CREATE INDEX idx_fait_temps ON oltp.FAIT_MESURES(id_temps) ;
CREATE INDEX idx_fait_timestamp ON oltp.FAIT_MESURES(timestamp_mesure) ;
CREATE INDEX idx_fait_conteneur_time ON oltp.FAIT_MESURES (id_conteneur, timestamp_mesure);
CREATE INDEX idx_fait_zone_time ON oltp.FAIT_MESURES (id_zone, timestamp_mesure);
