...
--Créer l'utilisateur ecotrack avec mot de passe
CREATE USER ecotrack_user WITH PASSWORD 'ecotrack123';
-- Donner tous les droits à cet utilisateur
GRANT ALL PRIVILEGES ON DATABASE ecotrack_dw TO ecotrack_user;
...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO ecotrack_user;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO ecotrack_user;

ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL PRIVILEGES ON TABLES TO ecotrack_user;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT ALL PRIVILEGES ON SEQUENCES TO ecotrack_user;